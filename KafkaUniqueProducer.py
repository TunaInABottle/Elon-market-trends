...
class KafkaUniqueProducer:
    def __init__(self) -> None:
        pass

    def get_last_message(self, k_consumer: KafkaConsumer, which_topic: TopicPartition, last_offset: int) -> str:
        """
        TODO 
    ...
    def last_message_topic(self, which_topic: TopicPartition) -> typing.Tuple[str, int]:
        """
        TODO
        """
        ...
        if last_offset > 1:
            last_mex = self.get_last_message(consumer, which_topic, last_offset)
        
        consumer.close()
        return last_mex, last_offset

    def write_list_in_queue(self, topic: str, obj_list: list) -> None:
        """
        TODO
    ...
    def filter_duplicates(self, message: str, objType: MessageData, from_list: list, skip_latest: bool = True ) -> list:
        """
        TODO
        """
