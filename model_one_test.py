...
def get_market_data(sparksession, mkt_name, hours_ago):
...
def get_tweet_data(sparksession, hours_ago):
    data = reversed(read_queue_by_ts('TWEETS', 0, hours_ago * HOUR_IN_MILLISEC ))

    s_tweet = tweet_list_to_spark(sparksession, data)
...
def tweet_list_to_spark(sparksession, data):
